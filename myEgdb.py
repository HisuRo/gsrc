...
class EG(object):
    ...
    def dims_indices_3d(self, dimxyz):
        dxidx = [i for i in range(self.dimsize[dimxyz[0]])]
        dyidx = [i for i in range(self.dimsize[dimxyz[1]])]
        dzidx = [i for i in range(self.dimsize[dimxyz[2]])]
