...
class comb_R:
    ...
    def __init__(self, sn=174070, sub=1):
        ...
        self.ech = get.ech_v2(sn=sn, tstart=self.ch1.Iamp.time[0], tend=self.ch1.Iamp.time[-1])
        self.nb = get.nb_alldev(sn=sn, tstart=self.ch1.Iamp.time[0], tend=self.ch1.Iamp.time[-1])
        self.wp = get.wp(sn=sn, sub=sub, tstart=self.ch1.Iamp.time[0], tend=self.ch1.Iamp.time[-1])
        self.nel = get.nel(sn=sn, sub=sub, tstart=self.ch1.Iamp.time[0], tend=self.ch1.Iamp.time[-1])
...
class comb_U:
    ...
    def plot_ch(self, freq=43, tstart=False, tend=False):
